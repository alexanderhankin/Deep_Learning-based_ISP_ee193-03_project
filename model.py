# The DeepISP network architecture
# This code defines the network architecture for DeepISP, 
#   including the definition of the network layers 
# Adapted from https://github.com/asutic/DeepISP
